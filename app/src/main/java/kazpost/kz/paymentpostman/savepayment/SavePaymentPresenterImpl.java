...
import kazpost.kz.paymentpostman.data.network.savepaymentsrvrequest.SavePaymentSrvBody;
import kazpost.kz.paymentpostman.data.network.savepaymentsrvrequest.SavePaymentSrvData;
